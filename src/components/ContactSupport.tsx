  ...
  return (
    <section className="contact-support-section">
      <div className="contact-support-inner">
        <a href="mailto:verify@connectnigeria.com" className="contact-card">
          ...
          <div className="contact-details">
            ...
            <span className="contact-value">verify@connectnigeria.com</span>
          </div>
        </a>

        <a href="tel:+2348003266328" className="contact-card">
          <div className="contact-icon-wrap">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="contact-details">
            ...
            <span className="contact-value">+234 800 CONNECT</span>
          </div>
        </a>
      </div>
    </section>
